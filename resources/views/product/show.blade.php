...
@section('content')
<!-- Bagian background bisa diganti sesuai kebutuhan -->
<div class="bg-gradient-to-b from-yellow-50 to-white min-h-screen">
    <div class="max-w-7xl mx-auto px-4 py-12 relative">
        ...
        <a href="{{ route('product.index') }}" class="absolute top-4 right-4">
            <button
                class="bg-white text-center w-48 rounded-2xl h-14 relative text-black text-xl font-semibold group shadow-md hover:shadow-lg"
                type="button"
            >
                <div
        ...
        <div class="flex flex-col md:flex-row gap-8 mt-12">
            ...
            <div class="md:w-1/2 flex flex-col justify-center">
                ...
                <!-- Tombol Pemesanan -->
                <a 
                    href="https://wa.me/6288239715035?text={{ urlencode('saya ingin memesan ' . $product->nama_produk) }}" 
                    class="inline-block bg-gradient-to-r from-green-400 to-blue-500 text-white px-8 py-3 rounded-lg text-lg font-semibold shadow-md hover:from-green-500 hover:to-blue-600 transition duration-300"
                >
                    Pesan Sekarang
                </a>
            </div>
                ...
                @foreach($relatedProducts as $related)
                    ...
                    >
                        @if($related->gambar)
                            ...
                            >
                        @else
                            <div class="w-full h-44 bg-gray-200 rounded-t-lg flex items-center justify-center">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600">
                                {{ \Illuminate\Support\Str::limit($related->deskripsi, 50) }}
                            </p>
                        </div>
                    </a>
                @endforeach
