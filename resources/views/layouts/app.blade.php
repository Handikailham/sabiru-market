...
<body class="bg-white text-gray-700">
  ...
  <div class="border-t-2 border-black-500 my-8"></div>
  ...
  <footer class="bg-white py-10">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <h3 class="text-3xl font-bold text-gray-800">Sabiru Market</h3>
          <p class="text-gray-600 mt-2">Nikmati menu terbaik dengan cita rasa yang tak terlupakan.</p>
          <div class="mt-4 space-y-1">
            <p class="text-gray-600"><strong>Alamat:</strong> Jl. Contoh No. 123, Kota Contoh, Indonesia</p>
            <p class="text-gray-600"><strong>Telepon:</strong> +62 882 3971 5035</p>
            <p class="text-gray-600"><strong>Email:</strong> info@burgerbrand.com</p>
          </div>
        </div>
        <!-- Kolom Kanan: Navigasi -->
        <div class="md:text-right">
          <h4 class="text-2xl font-semibold text-gray-800">Navigasi</h4>
          <ul class="mt-4 space-y-2">
            <li><a href="{{ route('index') }}" class="text-gray-600 hover:text-gray-800 transition">Beranda</a></li>
            <li><a href="{{ route('product.index') }}" class="text-gray-600 hover:text-gray-800 transition">Menu</a></li>
          </ul>
        </div>
      </div>
      <!-- Sosial Media -->
      <div class="mt-10 pt-6">
        <div class="flex flex-col md:flex-row md:justify-center items-center space-y-4 md:space-y-0 md:space-x-12">
          ...
          <div class="flex flex-col items-center">
            <a href="https://wa.me/6288239715035" target="_blank" aria-label="WhatsApp" class="text-gray-800 hover:text-gray-600 transition">
            ...
            <span class="text-gray-600 text-sm mt-1">WhatsApp</span>
          </div>
          <!-- Instagram -->
          <div class="flex flex-col items-center">
            <a href="#" target="_blank" aria-label="Instagram" class="text-gray-800 hover:text-gray-600 transition">
              <svg class="w-8 h-8 fill-current" viewBox="0 0 448 512">
            ...
            <span class="text-gray-600 text-sm mt-1">Instagram</span>
          </div>
          <!-- X (Twitter) -->
          <div class="flex flex-col items-center">
            <a href="#" target="_blank" aria-label="X" class="text-gray-800 hover:text-gray-600 transition">
            ...
            <span class="text-gray-600 text-sm mt-1">X</span>
          </div>
        </div>
      </div>
      <!-- Bawah: Copyright -->
      <div class="mt-8 border-t border-gray-300 pt-4 text-center">
        <p class="text-gray-600 text-sm">&copy; 2025 BurgerBrand. All rights reserved.</p>
      </div>
    </div>
  </footer>
